=== GeoDirectory - Porto Compatibility Pack ===
...
The plugin does a very simple thing. Through action hooks and filters, it removes the default html wrappers from GeoDirectory templates and adds Porto html wrappers.

This make GeoDirectory pages display gracefully when used with Porto.

= Requires GeoDirectory and Porto theme from SW-THEMES =

* [Get GeoDirectory](https://wordpress.org/plugins/geodirectory/).
* [Get GeoDirectory Addons](http://wpgeodirectory.com/).
* [Get Porto](http://themeforest.net/user/sw-themes).
...
Automatic installation is the easiest option. To do an automatic install (make sure you already have GeoDirectory and Porto installed), log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
In the search field type "GeoDirectory - Porto Compatibility Pack" and click Search Plugins. Once you've found the compatibility plugin you install it by simply clicking Install Now.
= Manual installation =
